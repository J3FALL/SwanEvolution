...
def getRange(y, m, d, h, **options):
    ...
    return [Round(float(min(wind))) , Round(float(max(wind)))] # this function returns values depicting interval correlated with distribution of drag function's values,
