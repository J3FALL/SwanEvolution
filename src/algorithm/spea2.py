...
class SPEA2:
    def __init__(self, params, new_individ, objectives, crossover, mutation, pop_variance):
        '''
        ...
        :param pop_variance: function to monitor variance of some parameter of the population by generations
        '''
        self.params = params
    ...
    class Params:
        def __init__(self, max_gens, pop_size, archive_size, crossover_rate, mutation_rate=0.25):
    ...
    class ErrorHistory:
        ...
        def add_new(self, genotype, genotype_index, fitness, pop_variance):
            self.history.append(SPEA2.ErrorHistory.Point(genotype=genotype, genotype_index=genotype_index,
                                                         fitness_value=fitness, pop_variance=pop_variance))
    ...
    def solution(self):
        ...
        while gen < self.params.max_gens:
            ...
            if last_fit > best.fitness():
                ...
                print("new best individ found at %d generation: %0.4f, %s" % (gen, best.fitness(), best.objectives))

                history.add_new(best_gens, gen, best.fitness(), self.pop_variance(self._archive))
