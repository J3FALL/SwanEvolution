...
space = hp.choice('a',
    [
        (hp.randint("max_gens", 15)*2+6,hp.randint("pop_size", 20)+10,hp.uniform("archive_size_rate", 0.05,0.4)*2,hp.uniform("crossover_rate", 0.1, 0.9),hp.uniform("mutation_rate", 0.1, 0.9))
    ])
