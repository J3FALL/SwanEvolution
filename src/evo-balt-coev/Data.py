...
def newCSV(modelDate):
    ...
    wr = csv.writer(file, dialect='excel')  # , quoting=csv.QUOTE_ALL
    wr.writerow(
        [' Pop '] +[' coevError ']+ [' Coeff_0 '] + [' Coeff_1 '] + [' ID_0 '] + ['Pop_0'] + [' finErrorDist_0 '] + [' params_0 '] + [' errors_0 '] + [' ID_1 '] + ['Pop_1'] + [
...
def writeCoevolution(modelDate, coindividualds):
    ...
    map(lambda coind: wr.writerow([coind.Pop,coind.coevError,coind.couple[0].ensCoeff,coind.couple[1].ensCoeff,coind.couple[0].ID, coind.couple[0].pop, Supply.fullErrorFunction(coind.couple[0]), coind.couple[0].params, coind.couple[0].fullErrors,coind.couple[1].ID,
                                 coind.couple[1].pop, Supply.fullErrorFunction(coind.couple[1]), coind.couple[1].params, coind.couple[1].fullErrors,coind.couple[0].forecasts,coind.couple[1].forecasts]), coindividualds)
    file.close()
    return 0
...
def writeCoevolutionFront(modelDate, coindividualds):
    ...
    map(lambda coind: wr.writerow(
        [coind.Pop, coind.coevError,coind.couple[0].ensCoeff,coind.couple[1].ensCoeff, coind.couple[0].ID,coind.couple[0].pop, Supply.fullErrorFunction(coind.couple[0]), coind.couple[0].params,
